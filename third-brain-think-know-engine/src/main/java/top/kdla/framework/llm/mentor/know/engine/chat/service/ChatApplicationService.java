package top.kdla.framework.llm.mentor.know.engine.chat.service;

import top.kdla.framework.llm.mentor.know.engine.ai.constant.KnowEngineIntent;
import top.kdla.framework.llm.mentor.know.engine.ai.model.IntentRecognitionResult;
import top.kdla.framework.llm.mentor.know.engine.ai.service.CommonChatService;
import top.kdla.framework.llm.mentor.know.engine.ai.service.IntentRecognitionService;
import top.kdla.framework.llm.mentor.know.engine.ai.service.KnowEngineChatAiService;
import top.kdla.framework.llm.mentor.know.engine.ai.service.PromptService;
import top.kdla.framework.llm.mentor.know.engine.ai.service.TitleSummaryService;
import top.kdla.framework.llm.mentor.know.engine.business.converter.CarInfoConverter;
import top.kdla.framework.llm.mentor.know.engine.business.converter.MyCarConverter;
...
import top.kdla.framework.llm.mentor.know.engine.business.service.CarInfoService;
...
import top.kdla.framework.llm.mentor.know.engine.chat.memory.DatabaseChatMemoryStore;
import top.kdla.framework.llm.mentor.know.engine.document.entity.TableMeta;
import top.kdla.framework.llm.mentor.know.engine.document.service.KnowEngineTableMetaService;
import top.kdla.framework.llm.mentor.know.engine.document.service.KnowledgeSegmentService;
import top.kdla.framework.llm.mentor.know.engine.document.util.DocumentPermissionUtils;
import top.kdla.framework.llm.mentor.know.engine.rag.constant.RoleEnum;
import top.kdla.framework.llm.mentor.know.engine.rag.modules.*;
import top.kdla.framework.llm.mentor.know.engine.rag.modules.reranker.BgeScoringModel;
...
import static top.kdla.framework.llm.mentor.know.engine.rag.config.ElasticSearchConfiguration.INDEX_NAME;
import static top.kdla.framework.llm.mentor.know.engine.rag.constant.MetadataKeyConstant.ACCESSIBLE_BY;
...
public class ChatApplicationService {
     ...
     * 统一流式对话入口。
     * <p>
     * 封装原本散落在 {@link top.kdla.framework.llm.mentor.know.engine.chat.controller.ChatController} 中的完整对话流程：
